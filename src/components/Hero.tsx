export default function Hero() {
  return (
    <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white pt-32 pb-24 px-4 overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
            Breathe <span className="text-orange-400">Cleaner Air</span><br />
            In Your Home
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            ...
            <a
              href="#services"
              className="bg-white/10 hover:bg-white/20 border border-white/30 text-white font-bold px-8 py-4 rounded-full text-lg transition-colors"
            >
              Our Services
            </a>
          </div>
          ...
          {/* Trust badges */}
          <div className="flex flex-wrap justify-center lg:justify-start gap-6 mt-10 text-blue-200 text-sm">
