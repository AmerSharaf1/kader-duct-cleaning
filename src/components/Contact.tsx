    ...
    <section id="contact" className="scroll-mt-16 py-24 bg-white px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          {/* Left info */}
          <div>
            <span className="text-emerald-600 font-semibold text-sm uppercase tracking-widest">Get in Touch</span>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+16471234567" className="text-emerald-600 hover:underline">(647) 123-4567</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:info@kaderduct.com" className="text-emerald-600 hover:underline">info@kaderduct.com</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-slate-500">Mon–Sat: 7am – 8pm | Sun: 9am – 5pm</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100">
            {submitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-slate-500">We received your request and will contact you within the hour.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white resize-none"
                ...
                <button
                  type="submit"
                  className="w-full bg-amber-500 hover:bg-amber-400 text-white font-bold py-4 rounded-xl text-lg transition-colors shadow-md"
                >
